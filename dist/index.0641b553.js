...
async function fetchCountries() {
    try {
        const response = await (0, _axiosDefault.default).get("https://restcountries.com/v3.1/all?fields=name,flag,region,population");
    ...
    /* countryList.innerHTML = `
        ...
        <li>Has a poluation of ${response.data[0].population} people`</li>*/ } catch (e) {
        console.error(e);
        ...
        else if (e.response.status === 500) errorMessage.textContent = "Internal Service Error | 500";
...
var Buffer = require("848b24ce47efe46a").Buffer;
"use strict";
/**
...
},{"848b24ce47efe46a":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("dc6fc0ef2a9a7c63");
var ieee754 = require("8aca42956f681718");
...
},{"dc6fc0ef2a9a7c63":"eIiSV","8aca42956f681718":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
